...
public class StudentTest {
    ...
    public void finalizeCoursesShouldProperlyChangeStateOfAllCourses() {
        ...
        ExamTime examTime = new ExamTime(LocalDateTime.parse("2020-9-01T16:00:00", DateTimeFormatter.ofPattern("yyyy-M-d'T'HH:mm:ss")),
                LocalDateTime.parse("2020-9-01T16:30:00", DateTimeFormatter.ofPattern("yyyy-M-d'T'HH:mm:ss")));
        String[] prerequisites = {};
        Course course1 = new Course(1, "Internet Engineering", "Ehsan Khamespanah", 3, classTime, examTime, 100, prerequisites);
        Course course2 = new Course(2, "Internet Engineering", "Ehsan Khamespanah", 3, classTime, examTime, 100, prerequisites);
        Course course3 = new Course(3, "Internet Engineering", "Ehsan Khamespanah", 3, classTime, examTime, 100, prerequisites);
